...
We install and load the package DescTools to winsorize the data at the 5% and 95% levels
...
variables_to_winsorize <- c('sale', 'cogs', 'xsga', 'dp_ex_am', 'ib', 
                            'oancf', 'rect', 'act', 'ppent', 'at', 'td')
