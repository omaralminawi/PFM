...
```{r}
# Winsorize ROE and lROE at the 1% and 99% levels
# beneish_data$roe <- Winsorize(beneish_data$roe, probs = c(0.01, 0.99))
# beneish_data$lroe <- Winsorize(beneish_data$lroe, probs = c(0.01, 0.99),na.rm = TRUE)
